...
import { getAddressFromPrivateKey } from '@stkon-js/crypto';
import { HttpProvider, Messenger } from '@stkon-js/network';
import { ChainID, ChainType, isValidAddress } from '@stkon-js/utils';
...
const msgHttp = new Messenger(http, ChainType.Stkon, ChainID.StkLocal);
// const msgWs = new Messenger(ws, ChainType.Stkon, ChainID.StkLocal);
